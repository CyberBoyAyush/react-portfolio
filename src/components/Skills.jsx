    ...
    <div className="relative min-h-screen py-20 px-4 sm:px-6" id="skills">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="text-center mt-16 bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-8 rounded-3xl backdrop-blur-sm border border-purple-500/20"
        >
          <h3 className="text-2xl font-bold text-purple-200 mb-3">Always Learning</h3>
          <p className="text-gray-300 max-w-2xl mx-auto">
            Technology is constantly evolving, and so am I. I'm passionate about learning new skills
